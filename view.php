...
<body>
    <div class="container find" style="padding-top: 30px; padding-left: 30px;">
        <h4>Tìm kiếm theo</h4>

        <div class="address">
            <p>Địa điểm:</p>
            <form method="post">
                <select name="address" id="address" class="form-control" style="width: 420px;">
        ...
        <div class="col-xs-12 col-md-6">
            <div class="motel row">
                ...
                <div class="col-md-7 col-sm-12 col-xs-12">
                    <div>
                        <h5>
                            <a href="details.php?Motel_Id=<?php echo $row['Motel_Id']; ?>" style="text-decoration: none;"><h3><?php echo $row['title']; ?></h3></a>                           
                        </h5>
                    </div>
    ...
    <h4 style="margin-left: 12px;"> PHÒNG TRỌ MỚI ĐĂNG NHẤT</h4>
    ...
    <h4 style="margin-left: 12px;"> PHÒNG TRỌ XEM NHIỀU NHẤT</h4>
