                    ...
                    <div class="row">
                        <div class="col d-flex flex-row">
                            <div class="top_bar_contact_item">
                                <diFv class="top_bar_icon"><img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1560918577/phone.png" alt=""></diFv>+91 9823 132 111
                            </div>
                            <div class="top_bar_contact_item">
                            ...
                            <div class="top_bar_content ml-auto">
                                <div class="top_bar_user">
                                    ...
                                    <div><a href="./login.php">Đăng nhập quản trị viên</a></div>
                                ...
                                <div class="header_search_content">
                                    <div class="header_search_form_container">
                                        <form method="post" class="header_search_form clearfix">
                                            <select name="address" id="address" class="form-control-search">
                                            ...
                                            <button type="submit" name="timkiem" class="header_search_button trans_300" value="Submit"><img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1560918770/search.png" alt=""></button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="main_nav_content d-flex flex-row">
                                    ...
                                    <div class="main_nav_menu">
                                        <ul class="standard_dropdown main_nav_dropdown">
                                            <li><a href="#">Home<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                            <li class="hassubs">
                                                <a hrFef="#">Laptop<i class="glyphicon glyphicon-chevron-down"></i>
                                                    <!-- <svg style="    margin-left: 2px;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                                                    </svg> -->
                                                </a>
                                                <ul>
                                                    <li>
                                                        <a href="#">Lenovo<i class="glyphicon glyphicon-chevron-down"></i></a>
                                                        <ul>
                                                            <li><a href="#">Lenovo 1<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                            <li><a href="#">Lenovo 3<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                            <li><a href="#">Lenovo 2<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="#">DELL<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                    <li><a href="#">APPLE<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                    <li><a href="#">HP<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                </ul>
                                            </li>
                                            <li class="hassubs">
                                                <a href="#">Featured Brands<i class="glyphicon glyphicon-chevron-down"></i></a>
                                                <ul>
                                                    <li>
                                                        <a href="#">APPLE<i class="glyphicon glyphicon-chevron-down"></i></a>
                                                        <ul>
                                                            <li><a href="#">Laptop<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                            <li><a href="#">Mobiles<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                            <li><a href="#">Ipads<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="#">Samsung<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                    <li><a href="#">Lenovo<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                    <li><a href="#">DELL<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                </ul>
                                            </li>
                                            <li class="hassubs">
                                                <a href="#">Pages<i class="glyphicon glyphicon-chevron-down"></i></a>
                                                <ul>
                                                    <li><a href="shop.html">Shop<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                    <li><a href="product.html">Product<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                    <li><a href="blog.html">Blog<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                    <li><a href="blog_single.html">Blog Post<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                    <li><a href="regular.html">Regular Post<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                    <li><a href="cart.html">Cart<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                    <li><a href="contact.html">Contact<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                                </ul>
                                            </li>
                                            <li><a href="blog.html">Blog<i class="glyphicon glyphicon-chevron-down"></i></a></li>
                                            <li><a href="contact.html">Contact<i class="glyphicon glyphicon-chevron-down"></i></a></li>
